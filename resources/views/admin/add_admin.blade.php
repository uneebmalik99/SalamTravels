                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Add New Sub Admin</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ url('admin/add_admin') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="contact" name="contact" type="text"
                                                    placeholder="Contact Person" class="form-control" required>
                                            </div>
                                        </div>
