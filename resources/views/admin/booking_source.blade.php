                       ...
                       <div class="row">
                           <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="booking_source" class="form-control" required>
                          ...
                          <?php $i = 1; ?>
                              @foreach ($data as $record)
                                <tr>
                                    ...
                                    <td>@if ($record->enable == 1)
                                      <a href="{{url('admin/disableBooking', ['id'=>$record->id])}}" class="text-blue"><i class="far fa-times-circle"></i></a>
                                      @else
                                      <a href="{{url('admin/enableBooking', ['id'=>$record->id])}}" class="text-blue"><i class="far fa-check-circle"></i></a>
                                    @endif
                                  </td>
                                    <?php $i++;?>
                                </tr>
