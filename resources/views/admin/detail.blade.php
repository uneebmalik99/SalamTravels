                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" autocomplete="off" name="from"
                                                            required value="{{ $ledger->from }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <input type="text" name="transaction" autocomplete="off"
                                                    required />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <input type="text" autocomplete="off" name="agency_name"
                                                    required />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 500px;">
                                            <div class="row w-100">
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" autocomplete="off"
                                                        name="p_basic" value="{{ $passenger->price->basic }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" autocomplete="off"
                                                        name="p_tax" value="{{ $passenger->price->tax }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" autocomplete="off"
                                                        name="p_discount"
                                                ...
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" autocomplete="off"
                                                        name="p_value" value="{{ $passenger->price->value }}" />
                                                </div>
                                            </div>
                                        </td>
                                        <td style="width: 25%;">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Remarks</label>
                                            <textarea class="form-control border" name="remarks" value="{{ $passenger->remarks }}">{{ $passenger->remarks }}</textarea>
                                        </div>
                                    </div>
                                </div>
