                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <input type="text" name="pnr" required value="{{ $ledger->pnr }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 500px;">
                                            <div class="row w-100">
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="p_basic"
                                                        value="{{ $passenger->price->basic }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="p_tax"
                                                        value="{{ $passenger->price->tax }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="p_discount"
                                                        value="{{ $passenger->price->discount }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="p_value"
                                        ...
                                        <td style="width: 25%;">
                                            <div class="row w-100">
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="v_basic"
                                                        value="{{ isset($passenger->vendor->basic) ? $passenger->vendor->basic : '' }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="v_tax"
                                                        value="{{ isset($passenger->vendor->tax) ? $passenger->vendor->tax : '' }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="v_discount"
                                                        value="{{ isset($passenger->vendor->discount) ? $passenger->vendor->discount : '' }}" />
                                                </div>
                                                <div class="col-sm-6 col-md-3">
                                                    <input type="text" style="width:50px;" name="v_value"
