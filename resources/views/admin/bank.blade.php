            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{url('admin/add_bank')}}" method="post">
                        @csrf
                       <div class="row">
                           <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label for="">Add Bank Name</label>
                 ...
                 <div class="card mt-5">
                    <div class="card-header">
                      <h4 class="card-title">Bank Names</h4>
                    </div>
                    <div class="card-body">
                          ...
                          <?php $i = 1; ?>
                              @foreach ($data as $record)
                                <tr>
                                    ...
                                    <td>@if ($record->enable == 1)
                                      <a href="{{url('admin/disableBank', ['id'=>$record->id])}}" class="text-blue"><i class="far fa-times-circle"></i></a>
                                      @else
                                      <a href="{{url('admin/enableBank', ['id'=>$record->id])}}" class="text-blue"><i class="far fa-check-circle"></i></a>
                                    @endif
                                  </td>
                                    <?php $i++; ?>
                                </tr>
