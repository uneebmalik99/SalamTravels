                                        ...
                                        <tbody>
                                            @if ($data != null)
                                                ...
                                                @foreach ($data as $record)
                                                    <tr class="clickable-row {{ $record->bgColor }}"
                                                        data-href="{{ url('admin/details/' . $record->id) }}">
                                                        <td>{{ $record->id }}</td>
                                                            ...
                                                            {{-- <select name="adminStatus"
                                                                ...
                                                                @foreach ($record->link as $link)
                                                                    <option
                                                                        ...
                                                                        @if ($record->status_id === $link->status_id) selected @endif>
                                                                        {{ $link->status->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select> --}}
                                                ...
                                                <form name="form12" id="form12">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" name="admin_remarks" id="admin_remarks" class="form-control"></textarea>
                                                        </div>
