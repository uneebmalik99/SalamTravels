                    ...
                    <div class="col-md-12 p-0 m-0">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <br />
                                <a href="/admin/downloadPdf" style="color:blue; padding:10px;">Download PDF</a>
                                <a href="/admin/exportLedger" style="color:blue; padding:10px;">Download Excel</a>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    @if ($record->ledger && $record->passengers)
                                                        @foreach ($record->passengers as $passenger)
                                                            <tr>
                                                                ...
                                                                @endphp
                                                                <td
                                                                    {{ $dt < $record->ledger->dep_date ? 'style=background-color:red;color:white;' : 'style=color:#000000;' }}>
                                                                    @if ($record->ledger)
                                                                ...
                                                                <td
                                                                    {{ $dt < $record->ledger->arr_date ? 'style=background-color:red;color:white;' : 'style=color:#000000' }}>
                                                                    @if ($record->ledger)
