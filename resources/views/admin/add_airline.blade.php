                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="airline_name" class="form-control"  autocomplete="off" required>
                                                @error('airline_name')
                                    ...
                                    @if ($data != null)
                                        ...
                                        @foreach ($data as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($record->enable == 1)
                                                        <a href="{{ url('admin/disableAirline', ['id' => $record->id]) }}"
                                                            class="text-blue"><i
                                                                class="far fa-times-circle"></i></a>
                                                    @else
                                                        <a href="{{ url('admin/enableAirline', ['id' => $record->id]) }}"
                                                            class="text-blue"><i
