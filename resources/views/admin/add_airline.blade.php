            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{url('admin/add_airline')}}" method="post">
                        @csrf
                       <div class="row">
                 ...
                 <div class="card mt-5">
                  <div class="card-header">
                    <h4 class="card-title">Airline Name</h4>
                  </div>
                  <div class="card-body">
                        ...
                        <?php $i = 1; ?>
                            @foreach ($data as $record)
                              <tr>
                                  ...
                                  <td>@if ($record->enable == 1)
                                    <a href="{{url('admin/disableAirline', ['id'=>$record->id])}}" class="text-blue"><i class="far fa-times-circle"></i></a>
                                    @else
                                    <a href="{{url('admin/enableAirline', ['id'=>$record->id])}}" class="text-blue"><i class="far fa-check-circle"></i></a>
                                  @endif
                                </td>
                                  <?php $i++; ?>
                              </tr>
