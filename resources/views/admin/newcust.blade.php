                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title text-center">Add New Sub Agent</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ url('admin/addNewCustomer') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="phone" name="phone" type="text"
                                                    placeholder="Phone" autocomplete="off" class="form-control"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="agency_name" id="agency_name" type="text"
                                                    autocomplete="off" placeholder="Agency Name" class="form-control"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="mobile" name="mobile" type="text"
                                                    placeholder="Mobile" autocomplete="off" class="form-control"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                {{-- test ledger link    ledger_link --}}
                                                <label class="control-label" for="phone">Credit Limit</label>
                                                <input name="credit_limit" id="credit_limit"
                                                    placeholder="Credit Limit" autocomplete="off" type="number"
                                                    class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="agency_picture" id="agency_picture" type="file"
                                                    class="form-control border-0" required>
                                            </div>
                                        </div>
                                        {{-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
