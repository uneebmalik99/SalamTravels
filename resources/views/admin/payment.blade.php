                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                            ...
                            <thead>
                                ...
                                <tr>
                                    <td><a href="#" class="viewImage">View <div style="display: none;" class="payment_proof">{{asset('public/images/'. $record->payment_proof)}}</div></a></td>  
                                    <td>{{$record->payment_date}}</td>
                                    <td>{{$record->bank[0]->bank_name}}</td>
                                    <td>{{$record->amount}}</td>
                                    <td style="width: 15%;"><select name="adminStatus" id="adminStatus" class="form-control"  onchange="location = this.value;">
                                      @foreach ($record->link as $link)
                                        <option value="{{url($link->link, ['id'=>$record->id])}}" 
                                          @if ($record->status->id === $link->status_id)
                                            selected
                                          @endif>{{$link->status->name}}</option>
                                      @endforeach
                                      </select>
                                  </td>
                                    ...
                                    -->
                                    <td><a href="#" class="viewDetails">view <div style="display: none;" class="remarks">{{$record->remarks}}</div></a></td>
                                    <td><a href="#" class="addAdminStatus" id="{{$record->id}}">Add <div style="display: none;" class="adremarks">{{$record->admin_remarks}}</div></a></td>
                                </tr>
                                @endforeach
                            @else
                    ...
                    <div class="modal fade" id="exampleModal12" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add Admin Remarks</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            </div>
                            <form name="form12" id="form12">
                                ...
                                <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-primary add_admin_remarks">Add</button>
                                </div>
                            </form>
                        </div>
                        </div>
