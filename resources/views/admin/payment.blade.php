                                            ...
                                            @if ($data != null)
                                                ...
                                                @foreach ($data as $record)
                                                    <tr>
                                                        <td>{{ $i }}</td>
                                                        <?php $i++;  ?>
                                                        <td>{{ (($record->customer->agency_name)??'no agency') }}</td>
                                                        ...
                                                        <td style="width: 15%;">
                                                            <select name="adminStatus" id="adminStatus"
                                                                class="form-control adminStatus"
    ...
    <script>
        $(document).ready(function() {
         ...
         function freezeStatus() {
            // let statusValue = $('.adminStatus').children(":selected").attr("id");
            ...
            //     $('#Processing').attr("disabled", true);
            // }
            $('.adminStatus').each(function(index){
                //console.log( index + ": " + $( this ).children(":selected").attr("id") );
        ...
        $(document).on('click', '#delete', function() {
            $(this).closest('tr').css({'webkit-touch-callout': 'none',
                    ...
                    'cursor': 'not-allowed'});
            //$('#adminStatus').prop('disabled', 'disabled');
        });
