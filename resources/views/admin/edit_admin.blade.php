                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ url('admin/update-post') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="" name="name" type="text" autocomplete="off" value="{{ $user->name }}"
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="cnic_front">CNIC Front</label>
                                                <input name="cnic_front" id="cnic_front" type="file"
                                                    class="form-control border-0">
                                                @if ($errors->has('cnic_front'))
                                                    <span class="text-danger">{{ $errors->first('cnic_front') }}</span>
                                                @endif
                                                <img src="/public/images/{{$user->cnic_front}}" alt="cnic_front" width="250" height="150">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="cnic_back">CNIC back</label>
                                                <input name="cnic_back" id="cnic_back" type="file"
                                                    class="form-control border-0">
                                                @if ($errors->has('cnic_back'))
                                                    <span class="text-danger">{{ $errors->first('cnic_back') }}</span>
                                                @endif
                                                <img src="/public/images/{{$user->cnic_back}}" alt="cnic_front" width="250" height="150">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                @endif
                                                <img src="/public/images/{{$user->profile_pic}}" alt="profile_pic" width="250" height="150">
                                            </div>
                                        </div>
