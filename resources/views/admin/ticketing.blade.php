                                            ...
                                            @if ($data != null)
                                                ...
                                                @foreach ($data as $record)
                                                    <tr>
                                                        ...
                                                        <td>{{ $record->date }}</td>
                                                        <td style="width: 20% !important;"><select name="adminStatus"
                                                ...
                                                <!--<td class="text-center"><div class="mb-2"><a href="{{ url('admin/ticketingStatusSubmitted', ['id' => $record->id]) }}" class="bg-warning p-1 mb-1">Submitted</a>&nbsp;<a href="{{ url('admin/ticketingStatusProcessing', ['id' => $record->id]) }}" class="bg-secondary p-1 text-white mb-1">Processing</a>&nbsp;<a href="{{ url('admin/ticketingStatusCompleted', ['id' => $record->id]) }}" class="bg-success p-1 text-white">Completed</a></div><a href="{{ url('admin/ticketingStatusRejected', ['id' => $record->id]) }}" class="bg-danger p-1 text-white">Rejected</a> &nbsp; <a href="{{ url('admin/ticketingStatusPosted', ['id' => $record->id]) }}" class="bg-info p-1 text-white mb-1">Posted</a></td>
                                    -->
    ...
    <script>
        ...
        $(document).on('click', '.add_admin_remarks', function(e) {
            ...
            if (admin_remarks.length > 0) {
                $.ajax({
                    url: "{{ url('admin/ticketingStatus') }}/" + id,
                    method: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
