                                            ...
                                            @if ($data != null)
                                                ...
                                                @foreach ($admin as $record)
                                                    <tr>
                                                        ...
                                                        <td><img src="/public/images/{{$record->cnic_front}}" alt="cnic_front"></td>
                                                        <td><img src="/public/images/{{$record->cnic_back}}" alt="cnic_back"></td>
                                                        <td><img src="/public/images/{{$record->profile_pic}}" alt="profile_pic"></td>
