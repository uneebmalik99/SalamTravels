                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Vendor Source</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ url('admin/vendor_source') }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="">Source Vendor</label>
                                                <input type="text" name="vendor_name"  autocomplete="off" class="form-control" required>
                                                @error('vendor_name')
                                    ...
                                    @if ($data != null)
                                        ...
                                        @foreach ($data as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($record->enable == 1)
                                                        <a href="{{ url('admin/disable_vendor_source', ['id' => $record->id]) }}"
                                                            class="text-blue"><i
                                                                class="far fa-times-circle"></i></a>
                                                    @else
                                                        <a href="{{ url('admin/enable_vendor_source', ['id' => $record->id]) }}"
                                                            class="text-blue"><i
