        ...
        -->
            ...
            <div class="sidebar-wrapper" id="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="{{ url('admin/save_manual_request') }}">
                            <i class="fas fa-money-bill-wave"></i>
                            <p>Request Manual</p>
                        </a>
                    </li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{ url('admin/save_manual_request') }}" method="POST">
                            @csrf
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label class="font-weight-bold label">Agency Name</label>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label class="font-weight-bold label">Transaction Date</label>
        ...
        function savePassengerForm(e) {
            ...
            $.ajax({
                ...
                success: function(e) {
                    console.log(e);
                    if (e.status == 200) {
                        alert('Manual Request Proceeded Successfully')
                        console.log(data);
                        location.reload();
                    } else {
            ...
            <div class="row text-center main_content">
                <div class="col-8">
                    <div class="row d-flex">
                        ...
                        <div class="col-3">
                            <input type="text" class="form-control ticket" name="ticket"  maxlength="14" required />
                        </div>
                    </div>
                </div>
                <div class="col-8">
                    <div class="row d-flex">
                        ...
                        <div class="col-3" style="background: #E5E7E9;">
