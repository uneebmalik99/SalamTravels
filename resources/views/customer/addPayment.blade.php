                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="amount" name="amount" type="text" placeholder="Your amount" autocomplete="off"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="bank" id="bank" class="form-control" required>
                                                    ...
                                                    @foreach ($data['bank'] as $record)
                                                        <option value="{{ $record->id }}">{{ $record->bank_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="payment_date" id="payment_date" type="date" autocomplete="off"
                                                    class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label class="control-label" for="subject">Payment Proof
                                                    (Screenshot)</label>
                                                <input name="payment_proof" type="file" autocomplete="off" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
