                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($tabinfo->tabtype->tab_name == 'Ticketing')
                                                            <p class="lead">TICKET</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Date Change')
                                                            <p class="lead">DATE-CHANGE</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Approval')
                                                            <p class="lead">APPROVAL</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Baggage')
                                                            <p class="lead">BAGGAGE</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Credit')
                                                            <p class="lead">CREDIT</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Debit')
                                                            <p class="lead">DEBIT</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Ok To Board')
                                                            <p class="lead">
                                                                TO
                                                                BOARD</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Insurance')
                                                            <p class="lead">INSURANCE</p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'PL UK Form')
                                                            <p class="lead">
                                                                UK
                                                                FORM
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Hotel Res')
                                                            <p class="lead">
                                                                HOTEL RES
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Visa')
                                                            <p class="lead">
                                                                VISA
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Covid-19')
                                                            <p class="lead">
                                                                COVID-19
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Refund')
                                                            <p class="lead">
                                                                REFUND
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Void')
                                                            <p class="lead">
                                                                VOID
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Adjustment')
                                                            <p class="lead">
                                                                ADJUSTMENT
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Others')
                                                            <p class="lead">
                                                                OTHERS
                                                            </p>
                                                        @endif
                                                        @if ($tabinfo->tabtype->tab_name == 'Ummrah')
                                                            <p class="lead">
                                                                UMRAH
                                                            </p>
                                                        @endif
                            ...
                            <div class="row text-center">
                                <div class="col-8">
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-2">
                                            <p>{{ \illuminate\Support\Str::upper($psng->type) }}</p>
                                        </div>
                                        <div class="col-2">
                                            <p>{{ \illuminate\Support\Str::upper($psng->title) }}</p>
                                            </select>
                                        </div>
                                        <div class="col-3">
