    ...
    <div class="wrapper " style="padding: 0px; margin:0px; width:100%; ">
        <div class="main-panel" id="main-panel" style="padding: 0px; margin:0px; width:100%; ">
            <div class="content" style="padding: 0px; margin:0px; width:100%; ">
                <div class="row">
                    <header>Salam Travels &amp; Tours

                            <div class="d-flex justify-content-between header-items">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($passenger)
                                                                        ...
                                                                        <span {{($dt>($record->ledger->dep_date))?'style=background-color:red;color:white;':'style=color:#fff;'}}>{{ $record->ledger->to }}</span>~
