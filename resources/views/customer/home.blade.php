        ...
        -->
          <div class="logo">
            <a href="{{url('/home')}}" class="simple-text logo-mini">
              <img src="{{asset('public/images/').'/'.$data->customer->agency_picture}}" class="navbar-brand" width="30" height="30" alt="">
            </a>
                          ...
                          <tbody>
                            @if ($data != null)
                              ...
                              <tr>
                                ...
                                <td><a href="#" class="viewDetails">view <div style="display: none;" class="remarks">{{$record->admin_remarks}}</div></a></td>
                              </tr>
                                @endforeach
                            @endif
