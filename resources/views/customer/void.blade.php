            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <!-- contact-form -->
                    <form method="POST" action="{{url('void')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    <label class="control-label" for="name">Airline Name</label>
                                    <select name="airline_name" id="airline_name" class="form-control" required>
                                      <option  disabled selected value> -- Select Airline -- </option>
                                      @foreach ($data['airline'] as $record)
                                        <option value="{{$record->id}}">{{$record->airline_name}}</option>
                                      @endforeach
                                    </select>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input name="pnr" id="pnr" type="text" placeholder="PNR" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="booking_source" id="booking_source" class="form-control" required>
                                      <option  disabled selected value> -- Select Booking Source -- </option>
                                      @foreach ($data['booking'] as $record)
                                        <option value="{{$record->id}}">{{$record->booking_source}}</option>
                                      @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input id="sector" name="sector" type="text" placeholder="Sector" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="passenger_name" id="passenger_name" placeholder="Any Passenger name from booking" required>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label class="control-label" for="textarea">Remarks</label>
                                    <textarea class="form-control" id="remarks" name="remarks" rows="4" placeholder="Your Messages"></textarea>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                                <button type="submit" name="singlebutton" class="btn btn-primary">Submit Request</button>
                            </div>
                        </div>
                    </form>
                    <!-- contact-form -->
