                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input id="pnr" name="pnr" type="text" placeholder="PNR" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="passenger_name" id="passenger_name" class="form-control" placeholder="Any Passenger name from booking"></textarea>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="remarks" name="remarks" rows="4" placeholder="Your remarks"></textarea>
                            </div>
                        </div>
