                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input name="pnr" id="pnr" type="text" placeholder="PNR" autocomplete="off"
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input id="sector" name="sector" type="text" placeholder="Sector" autocomplete="off"
                                                    class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="passenger_name" autocomplete="off"
