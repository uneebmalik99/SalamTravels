...
Route::get('admin/TabRequestSubmitted/{id}', [adminController::class, 'TabRequestSubmitted'])->middleware('role:1');
Route::get('admin/TabRequestPosted/{id}', [adminController::class, 'TabRequestPosted'])->middleware('role:1');
Route::get('admin/TabRequestProcessing/{id}', [adminController::class, 'TabRequestProcessing'])->middleware('role:1');
Route::get('admin/TabRequestCompleted/{id}', [adminController::class, 'TabRequestCompleted'])->middleware('role:1');
Route::get('admin/TabRequestRejected/{id}', [adminController::class, 'TabRequestRejected'])->middleware('role:1');
...
Route::get('admin/downloadPdf', [ledgerController::class, 'showAdminPdf'])->middleware('role:1');
Route::get('admin/exportLedger', [ledgerController::class, 'exportAdminLedger'])->middleware('role:1');
...
Route::get('admin/save_manual_request', [adminController::class, 'saveManualRequest']);
...
Route::get(('/admin/delete_passenger'), [adminController::class, 'deletePassenger']);
...
Route::get('/admin/add_passenger_on_update', [adminController::class, 'ajaxAddPassengerOnUpdate']);
/**
 *
 * Ledger Update Ajax
 */
Route::get('/admin/update_ledger/${id}', [ledgerController::class, 'updateLedger'])->name('ledgerUpdate');
/***
 *
 * Passenger Update Ajax
 */
Route::get('/admin/passenger_update/${id}', [PassengerController::class, 'passengerUpdate'])->name('passengerUpdate');
Route::get('/customers', [PassengerController::class, 'customerTabStatusPosted']);
