...
<body class="">
                                        ...
                                        <select id="tab_status" class="form-control"
                                            ...
                                            @foreach ($links as $link)
                                                <option id="{{ $link->status->name }}"
                                                    ...
                                                    @if (Auth::user()->hasRole('Admin') && !Auth::user()->can($link->status->name)) disabled @endif>
                ...
                <div class="horizontal-scrollable bg-white p-3">
                        ...
                        @foreach ($passengers as $passenger)
                            <div class='passenger-info-update-form'>
                                ...
                                <div class="col-4">
                                 ...
                                 <div id="update-passenger-form-container"></div>
                                {{-- <button class="btn btn-primary updatepassenger" type="button"
                                    style="z-index: 999 !important;">Submit</button> --}}
                            </div>
                        @endforeach
                        <div class="text-center">
                            <button type="button"  class="btn btn-primary updatePassengerTemplate">Add Passenger</button>
                            </div>
                    ...
                    @else
                        ...
                        <form id='passenger-form-c' action="{{ url('admin/update_passenger_info/' . $tabinfo->id) }}"
                            ...
                            <div class="text-center">
                            <button type="button" class="btn btn-primary addPassengerTemplate">Add Passenger</button>
                            </div>
                            <div class="row text-center">
                                <div class="col-8">
                                    <div class="row d-flex">
    ...
    <script>
        ...
        $(document).on('click','.addPassengerTemplate',function(e){
            addPassengerForm();


        });
        $(document).on('click','.updatePassengerTemplate',function(e){
            addPassengerForm();
        ...
        $(document).on('change', '.type', function() {
                if(this.value === 'infant'){
                    ...
                    $(".title option[value='mr']").hide();
                    $(".title option[value='mrs']").text('MRS');
        ...
        function addPassengerForm() {
            ...
            var container = $('#second-passenger-form-container');
        ...
        function getPassengerUpdatedData() {
            ...
            passengerEl.each(function(i, v) {
                ...
                if($(v).find('.payment_type').val() == ""||$(v).find('.payment_type').val() == null ){
                    $(this).find('.payment_type').css('border-color','red')
                    return false
                }
                else{
                    obj.payment_type = $(v).find('.payment_type').val();
                }
                if($(v).find('.p_basic').val() == ""||$(v).find('.p_basic').val() == null ){
                    $(this).find('.p_basic').css('border-color','red');
                    return false;
                ...
                if($(v).find('.p_tax').val() == ""||$(v).find('.p_tax').val() == null ){
                    $(this).find('.p_tax').css('border-color','red');
                    return false;
                ...
                if($(v).find('.p_discount').val() == ""||$(v).find('.p_discount').val() == null ){
                    $(this).find('.p_discount').css('border-color','red')
                    return false;
                ...
                if($(v).find('.v_payment_type').val() == ""||$(v).find('.v_payment_type').val() == null ){
                    $(this).find('.v_payment_type').css('border-color','red')
                    return false;
                ...
                if($(v).find('.v_basic').val() == ""||$(v).find('.v_basic').val() == null ){
                    $(this).find('.v_basic').css('border-color','red')
                    return false;
                ...
                if($(v).find('.v_tax').val() == ""||$(v).find('.v_tax').val() == null ){
                    $(this).find('.v_tax').css('border-color','red')
                    return false;
                ...
                if($(v).find('.v_discount').val() == ""||$(v).find('.v_discount').val() == null ){
                    $(this).find('.v_discount').css('border-color','red')
                    return false;
        ...
        function getUpdatedeLedgerData() {
           ...
           // obj.date = $('#date').val();
            ...
            if($('#ledger_id').val() == ""||$('#ledger_id').val() == null ){
                    $('#ledger_id').css("border-color","red");
                    return false;
