...
class offlineTicketController extends Controller
{
    public function create()
    {
        ...
        return view('customer.offlineTicketing')->with(['data'=>$data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $mail->Subject = 'SALAM WEB PORTAL TICKETING REQUEST';
        $mail->Body = '<p>Dear Trade Partner</p><br>
            '.$customer[0]->agency_name.'<br>
            <p>YOUR NEW “TICKETING” REQUEST IS RECEIVED & FORWARD TO OUR TEAM FOR PROCESSING.</p><br><br>
        ...
        return back()->with(['success'=>'Ticket has been added successfully']);
