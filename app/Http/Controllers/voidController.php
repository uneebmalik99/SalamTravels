...
class voidController extends Controller
{
    public function create()
    {
        ...
        return view('customer.void')->with(['data'=>$data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $void = new Tabinfo();
        $void->create($data);$user = User::find(Auth::user()->id);
        ...
        $mail->Subject = 'SALAM WEB PORTAL Void REQUEST';
        $mail->Body = '<p>Dear Trade Partner</p><br>
            '.$customer[0]->agency_name.'<br>
            <p>YOUR NEW “Void” REQUEST IS RECEIVED & FORWARD TO OUR TEAM FOR PROCESSING.</p><br><br>
        ...
        return back()->with(['success'=>'Void data submitted successfully']);
    }
}
